...
echo ""
echo "주요 커맨드:"
echo "  시작    /kickoff, /architecture"
echo "  기능    /feature-start, /feature-plan, /task, /done"
echo "  검증    /code-review, /investigate, /qa, /design-review, /perf, /security-audit"
echo "  기록    /decision, /update-docs, /compile-spec, /project-status"
echo "  릴리스  /cleanup, /ship"
echo ""
echo "전체 목록과 사용법은 README.md 참조."
